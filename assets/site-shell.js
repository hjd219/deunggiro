document.addEventListener('DOMContentLoaded',()=>{
  ...
  const contact=`<section class="dg-shell-contact"><div class="dg-shell-contact-grid"><div><h2>복잡한 등기절차, 등기로에서 확인하세요.</h2><p>상속 · 법인 · 부동산 등 필요한 절차와 준비서류를 확인할 수 있습니다.</p></div><a class="dg-shell-phone" href="tel:0324251500">032-425-1500 상담</a></div></section>`;
  ...
  if(!document.querySelector('section.contact,section.cta,section.dg-shell-contact')) document.body.insertAdjacentHTML('beforeend',contact);
