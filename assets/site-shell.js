document.addEventListener('DOMContentLoaded',()=>{
  ...
  /* DETAIL_PAGE_RESTORE_V1: 현재 및 앞으로 생성되는 카테고리 세부페이지 공통 기준 */
  const detailPrefixes=['inheritance','corporate','realestate','renunciation','family'];
  const isDetailPage=detailPrefixes.some(prefix=>new RegExp('^/'+prefix+'-[^/]+\\.html
  ...
  if(isDetailPage && !document.querySelector('link[href*="inheritance-detail.css"]')){
