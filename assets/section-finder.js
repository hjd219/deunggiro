...
'부동산등기':[
 ...
 {title:'부동산 상속·증여·매매 등기 필요서류',href:'/posts/naver-224242416419.html',type:'핵심 안내'},
 {title:'가족간 부동산 증여 절차',href:'/posts/naver-224289926337.html',type:'핵심 안내'},
 {title:'전세권 설정·말소 절차',href:'/posts/naver-224346324401.html',type:'핵심 안내'},
 {title:'근저당권 설정·말소 절차',href:'/posts/mortgage-real-estate-procedure-16vqc8.html',type:'핵심 안내'},
 {title:'부동산 신탁등기 안내',href:'/posts/naver-224361399594.html',type:'핵심 안내'}
],
'가사':[
 ...
 {title:'인천 협의이혼 절차·관할·기간',href:'/posts/naver-224366421588.html',type:'핵심 안내'},
 {title:'인천 개명 허가 절차·필요서류',href:'/posts/name-change-incheon-procedure-guide-documents-4lfyb2.html',type:'핵심 안내'},
 {title:'미성년자 후견인·친권자 지정',href:'/posts/naver-224262221860.html',type:'핵심 안내'},
 {title:'성본변경 허가 기준',href:'/posts/naver-224263360119.html',type:'핵심 안내'}
]
...
(()=>{
  ...
  section.innerHTML=`<div class="container"><h2 class="ren-special-title">상속포기·한정승인 특수한 상황도 확인하세요</h2><p class="ren-special-desc">상속포기·한정승인 상황에 맞는 세부 안내를 바로 확인할 수 있습니다.</p><div class="ren-special-grid"><a class="ren-special-card" href="/posts/naver-224404912884.html"><div class="ren-special-head"><span class="ren-special-badge">사례</span><h3 class="ren-special-name">후순위 상속인</h3></div><p class="ren-special-copy">선순위 상속포기 후 소송으로 상속인 된 사실을 안 경우</p></a><a class="ren-special-card" href="/posts/naver-224408253127.html"><div class="ren-special-head"><span class="ren-special-badge">사례</span><h3 class="ren-special-name">특별한정승인</h3></div><p class="ren-special-copy">단순승인 후 뒤늦게 채무초과 사실을 안 경우 검토</p></a><a class="ren-special-card" href="/posts/naver-224404962663.html"><div class="ren-special-head"><span class="ren-special-badge">사례</span><h3 class="ren-special-name">해외거주 상속인</h3></div><p class="ren-special-copy">미국 등 해외 거주자가 3개월 경과 후 상속포기한 경우</p></a><a class="ren-special-card" href="/posts/naver-224408270820.html"><div class="ren-special-head"><span class="ren-special-badge">사례</span><h3 class="ren-special-name">미성년자 상속인</h3></div><p class="ren-special-copy">미성년자가 포함되어 특별대리인 선임이 필요했던 경우</p></a><a class="ren-special-card" href="/posts/naver-224405895781.html"><div class="ren-special-head"><span class="ren-special-badge">사례</span><h3 class="ren-special-name">상속재산파산</h3></div><p class="ren-special-copy">한정승인 후 부동산이 있어 상속재산파산까지 진행한 경우</p></a></div></div>`;
