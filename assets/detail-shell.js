...
@media(max-width:700px){body .faq-table{font-size:11px}body .faq-table th{width:50%;padding:8px 6px;letter-spacing:-.45px}body .faq-table td{padding:8px 7px}body .faq-kicker{font-size:9px;margin-right:4px}}
