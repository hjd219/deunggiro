...
let start=0,travel=0,maskH=0,trackH=0,viewportH=0,raf=0;
...
const measure=()=>{document.body.classList.remove('dg-r2-finished');track.style.transform='translate3d(0,0,0)';maskH=mask.clientHeight;viewportH=window.innerHeight;trackH=track.scrollHeight;travel=maskH+trackH;stage.style.height=(travel+viewportH)+'px';start=stage.offsetTop;render();};
