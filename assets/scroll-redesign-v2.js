...
const render=()=>{raf=0;const p=Math.max(0,(window.scrollY||0)-start);document.body.classList.toggle('dg-r2-started',p>1);const y=maskH-Math.min(p,travel);track.style.transform='translate3d(0,'+Math.round(y)+'px,0)';document.body.classList.toggle('dg-r2-finished',p>=travel);};
