...
const fixed=[
 {title:'법인설립',href:'#service-1',type:'업무안내'},
 {title:'변경등기 · 임원변경 · 상호변경 · 목적변경 · 본점이전',href:'#service-2',type:'업무안내'},
 {title:'자본금증자',href:'#service-3',type:'업무안내'},
 {title:'회사계속등기 · 해산간주 · 부활등기',href:'#service-4',type:'업무안내'},
 {title:'전자서명·인증',href:'#electronic-auth',type:'페이지'},
 {title:'과태료 예상기준표',href:'#penalty-guide',type:'페이지'},
